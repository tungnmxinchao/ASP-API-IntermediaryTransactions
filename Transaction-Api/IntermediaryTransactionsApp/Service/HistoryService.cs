...
namespace IntermediaryTransactionsApp.Service
{
    public class HistoryService : IHistoryService
    {
        ...
        public async Task<bool> CreateHistory(CreateHistoryRequest historyRequest)
        {
            ...
            history.IsProcessed = historyRequest.IsProcessed ?? true;
        ...
        {
            var histories = await _context.TransactionHistories.Include(u => u.User).ToListAsync();
        ...
        public async Task<List<TransactionHistory>> GetHistoryTransactions()
        {
            ...
            if (userId == null)
            {
                throw new UnauthorizedAccessException(
                    ErrorMessageExtensions.GetMessage(ErrorMessages.ObjectNotFoundInToken)
                );
            }

            return await _context.TransactionHistories.Where(i => i.UserId == userId).ToListAsync();
        }
    }
}
