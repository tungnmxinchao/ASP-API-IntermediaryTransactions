...
namespace IntermediaryTransactionsApp.Service
{
	public class AuthService
	{
		...
		public AuthService(JwtService jwtService, ApplicationDbContext dbContext, RedisService redisService)
		{
		...
		{
			var user = await _dbContext.Users.Include(r => r.Role).FirstOrDefaultAsync(u => u.Username == username);
